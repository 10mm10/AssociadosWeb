...
>({
  ...
  const pdfSelecionado = pdfs.find((pdf) => pdf.id === selectedPdfId);
          ...
          <form onSubmit={handleMobileSubmit}>
            ...
            <div className="mb-3">
              ...
              <div className="grid grid-cols-2 gap-1.5">
                <label
                  className={`flex cursor-pointer items-center justify-center rounded-md border px-2 py-2 text-[11px] font-semibold transition ${
                    tipoCliente === "fisica"
            ...
            {isLoading ? (
              ...
              clientes.map((cliente, index) => (
                <button
                  ...
                  className={`w-full rounded-lg border px-3 py-2 text-left transition active:scale-[0.99] ${
        ...
        {selectedClienteId && (
          <section className="rounded-lg bg-white p-3 shadow-sm">
            <div className="mb-3">
              ...
              <div
                className={`grid gap-2 ${
                  isProcuracaoSelecionada ? "grid-cols-2" : "grid-cols-3"
                }`}
              >
                {!isProcuracaoSelecionada && (
                  <>
                    <label
                ...
                {isProcuracaoSelecionada && pdfSelecionado && (
                  <button
                    type="button"
                    onClick={() =>
                      handleEnviarParaZapsign(
                    ...
                    className="cursor-pointer rounded-md bg-orange-500 px-2 py-2 text-xs font-semibold text-white transition active:scale-[0.99]"
                  >
                    Enviar ZapSign
                  </button>
                )}
            ...
            <input
              ...
              className="hidden"
            />
            {!isProcuracaoSelecionada && fileName && (
